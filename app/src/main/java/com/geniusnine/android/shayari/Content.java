...
public class Content extends AppCompatActivity {
    ...
    private MobileServiceSyncTable<HindiShayariContent> mobileServiceSyncTable;//Change the parameter
    private ContentAdapter contentAdapter;
    private RecyclerView recyclerViewContent;


    private ArrayList<HindiShayariContent> items = new ArrayList<>(); //Change the parameter
    ...
    private void fetchDataFromAzure() {
        ...
        try {
            ...
            mobileServiceSyncTable = mobileServiceClient.getSyncTable(getString(R.string.content_table_name), HindiShayariContent.class);//Change the parameter
            initLocalStore().get();
        ...
        AsyncTask<Void, Void, Void> task = new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                try {
                    ...
                    final List<HindiShayariContent> results = mobileServiceSyncTable.read(query).get();//Change the parameter
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            items.clear();
                            for (HindiShayariContent item : results) {//Change the parameter
                                items.add(item);
