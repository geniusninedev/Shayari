...
public class CategoryAdapter extends ArrayAdapter<HindiShayariCategory> {//Change the parameter
    Context context;

    int layoutResourceId;
    public List<HindiShayariCategory> mCategory; //Change the parameter
    ...
    public View getView(int position, final View convertView, ViewGroup parent) {
        ...
        final HindiShayariCategory currentItem = getItem(position); //Change the parameter
        if (row == null) {
