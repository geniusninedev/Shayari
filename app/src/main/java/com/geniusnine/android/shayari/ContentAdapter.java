...
public class ContentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ContentAdapter(Context context, ArrayList<HindiShayariContent> items) {//Change the parameter
        this.items = items;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position){
        ...
        HindiShayariContent item = items.get(position);//Change the parameter
